...
<div class="abs-bl mx-14 my-12 flex">
  <div class="ml-3 flex flex-col text-left">
    <div class="text-sm opacity-50">Amazon FAR AI, XXXXXXXXXX Date</div>
  </div>
</div>
...
<div class="mx-auto mt-[0.35rem] w-[54rem] text-right text-[0.68rem] font-semibold leading-none opacity-65">
  ...
  <span class="mx-[0.35rem]">·</span>
  <a href="https://arxiv.org/abs/2412.06685" target="_blank" rel="noopener noreferrer">
    Policy-Agnostic RL: Sobol Mark et al. (2024)
  </a>
</div>
...
<div class="absolute bottom-0 right-0 top-0 w-1/2 overflow-hidden border-l border-slate-200 bg-white">
  <img
    :src="'/deck/golden-gate-bridge-abstract.svg'"
    class="absolute inset-0 h-full w-full object-cover"
    alt="Abstract illustration of the Golden Gate Bridge"
  />
</div>

<div class="absolute left-[0.85rem] top-[1.25rem] z-10 w-[28rem] text-slate-950">
